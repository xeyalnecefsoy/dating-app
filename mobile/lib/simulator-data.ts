...
export const scenarios: Scenario[] = [
  {
    ...
    description: {
      en: "Start a conversation with someone interesting at a cafe.",
      az: "Kafedə maraqlı biri ilə söhbətə başlayın.",
    },
    initialMessage: {
      en: "Hey, is this seat taken? It's so crowded today.",
      az: "Salam, bu yer boşdur? Bu gün çox adam var.",
    },
    persona: {
      name: "Aylin",
  ...
  },
  {
    ...
    description: {
      en: "Navigate a difference of opinion on a first date gracefully.",
      az: "İlk görüşdə fikir ayrılığını nəzakətlə idarə edin.",
    },
    initialMessage: {
      en: "I actually don't think standard tests measure intelligence well. What do you think?",
      az: "Mən standart testlərin zəkanı düzgün ölçdüyünü düşünmürəm. Sən nə düşünürsən?",
    },
    persona: {
      name: "Orxan",
  ...
  },
  {
    ...
    description: {
      en: "Introduce yourself to a potential mentor.",
      az: "Potensial mentora özünüzü təqdim edin.",
    },
    initialMessage: {
      en: "Hi there! I saw you speaking earlier, really insightful points on AI ethics.",
      az: "Salam! Çıxışınızı izlədim, süni intellekt etikası barədə çox maraqlı məqamlara toxundunuz.",
    },
    persona: {
      name: "Leyla",
  ...
  },
  {
    ...
    description: {
      en: "Discuss a painting with a stranger.",
      az: "Yabancı biri ilə bir rəsm əsərini müzakirə edin.",
    },
    initialMessage: {
      en: "This painting is quite abstract, isn't it? What do you see in it?",
      az: "Bu rəsm olduqca abstraktdır, elə deyilmi? Siz bunda nə görürsünüz?",
    },
    persona: {
      name: "Tural",
...
// Local (non-AI) fallback for type-safety + offline testing.
export const analyzeMessage = (text: string, lang: "en" | "az"): AnalysisResult => {
  ...
  if (
    lowerText.match(
      /listen|understand|feel|agree|sorry|interesting|başa düşürəm|anlayıram|hiss|maraqlı|təəssüf/,
    )
  ) {
    empathy += 20;
    tone = "Friendly";
  ...
  if (lowerText.includes("?")) empathy += 5;
  ...
  let feedback = {
    en: "Good start! Try to ask more open-ended questions.",
    az: "Yaxşı başlanğıcdır! Daha çox açıq suallar verməyə çalışın.",
  };

  if (empathy > 70) {
    feedback = { en: "Great job showing empathy!", az: "Empatiya göstərməkdə əla iş!" };
  }
  if (confidence < 40) {
    feedback = { en: "Try to be a bit more direct and confident.", az: "Bir az daha birbaşa və inamlı olmağa çalışın." };
  }
  if (clarity > 80) {
    feedback = { en: "Your message is very clear and easy to understand.", az: "Mesajınız çox aydın və anlaşıqlıdır." };
  }
